...
// submit shot handoffs, watch them get classified by the worker, review the
// queue. Every page sits behind a shared password stored in SSM. It is
// mounted at ICR_DASHBOARD_BASE_PATH (/demos/amberlight) so marian.online can
...
import (
	...
	"github.com/marianina8/amberlight-icr-pipeline/internal/httplambda"
)
